...
# untuk bikin dataset yang beneran main program DDPG 2. DDPG 1 itu datanya bisa diskalain di normalisasi sesuai dengan robot yang digunakan
# agar input ke sistemnya sesuai. DDPG2 yang dimainin. state diganti sesuaiin sama sistem/. di policy while true. class train ddpg masuk ke fpga. sama yang buffer
# buffer yang nentuin buat jalanin training. learn block. update target untuk update target network. class buffer itu input ke network. class train, buffer
